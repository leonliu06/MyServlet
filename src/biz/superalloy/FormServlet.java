...
public class FormServlet extends HttpServlet {
	private static final long serialVerssionUID = 54L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		writer.println("<body><h1>" + TITLE + "</h1>");
		writer.println("<table>");
		writer.println("<tr><td>Name:</td><td>" + request.getParameter("name") + "</td></tr>");
		...
		writer.println("<tr><td>Shipping Instructions:</td>");
		writer.println("<td>");
		...
		writer.println("<tr><td>Delivery Method:</td><td>" + request.getParameter("deliveryMethod") + "</td></tr>");
		writer.println("<tr><td>Catalog Request:</td>");
		writer.println("<td>");
